...
$(document).ready(function(){
  ...
  $(document).ready(function(){
    ...
    function animateDrop($drop) {
      ...
      // Hent vandkandens position og dimensioner
      let canPosition = $("#wateringcan").offset();
      let canWidth = $("#wateringcan").outerWidth();
      let canHeight = $("#wateringcan").outerHeight();

     
      let mouthX = canPosition.left + canWidth -165; 
      let mouthY = canPosition.top + canHeight ;

      
      let randomOffsetX = Math.random() * 20 - 10; 
      let randomOffsetY = Math.random() * 10;  

      
      $drop.css({
          left: mouthX + randomOffsetX + "px",
          top: mouthY + randomOffsetY + "px"
      });
